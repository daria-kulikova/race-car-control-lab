#ifndef MHE_SOLVERS_MHE_SOLVER_H
#define MHE_SOLVERS_MHE_SOLVER_H
...
public:
  ...
  virtual void updateParams(
      int stage, const dynamicsType& model_dynamics, const costType& costs, const otherParams& others,
...
#endif  // MHE_SOLVERS_MHE_SOLVER_H
