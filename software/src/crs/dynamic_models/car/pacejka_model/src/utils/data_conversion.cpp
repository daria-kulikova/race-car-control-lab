...
{
template <>
const std::vector<casadi::MX> asCasadiSym<crs_models::pacejka_model::pacejka_car_state>()
{
...
template <>
const std::vector<casadi::MX> asCasadiSym<crs_models::pacejka_model::pacejka_car_input>()
{
