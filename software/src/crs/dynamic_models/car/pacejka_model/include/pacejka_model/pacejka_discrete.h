...
class DiscretePacejkaModel : public DiscreteDynamicModelWrapper<pacejka_car_state, pacejka_car_input>
{
private:
...
public:
   ...
   */
  DiscretePacejkaModel(pacejka_params params,
  ...
  DiscretePacejkaModel(pacejka_params params, std::string integration_method = "rk")
    : DiscretePacejkaModel(params,
                           Eigen::Matrix<double, DiscretePacejkaModel::NX, DiscretePacejkaModel::NX>::Identity(),
                           integration_method)
  {
