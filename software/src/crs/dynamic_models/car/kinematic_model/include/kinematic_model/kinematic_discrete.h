...
public:
  ...
  DiscreteKinematicModel(kinematic_params params,
                         Eigen::Matrix<double, DiscreteKinematicModel::NX, DiscreteKinematicModel::NX> Q,
   ...
   * collocation, oldcollocation, rk
   */
  DiscreteKinematicModel(kinematic_params params, std::string integration_method = "rk")
    : DiscreteKinematicModel(params,
                             Eigen::Matrix<double, DiscreteKinematicModel::NX, DiscreteKinematicModel::NX>::Identity(),
                             integration_method)
  {
   ...
   */
  kinematic_car_state applyModel(const kinematic_car_state state, const kinematic_car_input control_input,
