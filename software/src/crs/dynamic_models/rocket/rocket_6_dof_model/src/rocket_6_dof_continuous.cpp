 ...
 */
void ContinuousRocket6DofModel::getNumericalJacobian(const rocket_6_dof_state& state,
                                                     const rocket_6_dof_input& control_input, StateMatrix& A,
                                                     InputMatrix& B)
{
  ...
  rocket_6_dof_state unused_implicit_inputs;  // these here are only used to evaluate the jacobian if there are any
