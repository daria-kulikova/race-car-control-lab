#ifndef MPC_SOLVERS_KINEMATIC_TRACKING_MPC_SOLVER_H
#define MPC_SOLVERS_KINEMATIC_TRACKING_MPC_SOLVER_H
...
class KinematicTrackingMpcSolver
  : public MpcSolver<crs_models::kinematic_model::kinematic_params, tracking_costs, trajectory_track_point>
{
public:
  /**
   ...
   */
  virtual void updateParams(int stage, const crs_models::kinematic_model::kinematic_params& model_dynamics,
...
#endif /* MPC_SOLVERS_KINEMATIC_TRACKING_MPC_SOLVER_H */
