...
def build_acados_solver(N: int, Ts: float, acados_source_path: str, model, config):
    """
    ...
    ocp.constraints.uh = np.array([w * w])
    ...
    filename = "lib/acados_pacejka_mpcc_solver_config.json"
