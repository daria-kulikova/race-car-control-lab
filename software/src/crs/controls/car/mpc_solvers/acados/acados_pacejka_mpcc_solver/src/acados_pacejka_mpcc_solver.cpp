                                           ...
                                           const tracking_costs& costs, const trajectory_track_point& tracking_point)
{
  ...
  mpc_parameters[params::Cd0] = model_dynamics.Cd0;
  mpc_parameters[params::Cd1] = model_dynamics.Cd1;
  mpc_parameters[params::Cd2] = model_dynamics.Cd2;

  mpc_parameters[params::gamma] = model_dynamics.gamma;
  mpc_parameters[params::eps] = model_dynamics.eps;
  mpc_parameters[params::car_width] = model_dynamics.car_width;
  mpc_parameters[params::wheel_radius] = model_dynamics.wheel_radius;
