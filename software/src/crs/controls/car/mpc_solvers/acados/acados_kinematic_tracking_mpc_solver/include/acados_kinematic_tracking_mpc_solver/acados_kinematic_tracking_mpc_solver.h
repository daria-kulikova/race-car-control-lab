#ifndef ACADOS_KINEMATIC_TRACKING_MPC_SOLVER_ACADOS_KINEMATIC_TRACKING_MPC_SOLVER
#define ACADOS_KINEMATIC_TRACKING_MPC_SOLVER_ACADOS_KINEMATIC_TRACKING_MPC_SOLVER
...
class AcadosKinematicTrackingMpcSolver : public KinematicTrackingMpcSolver
{
private:
...
public:
   ...
   */
  void updateParams(int stage, const crs_models::kinematic_model::kinematic_params& model_dynamics,
...
#endif /* SRC_CRS_CONTROLS_MPC_SOLVERS_ACADOS_ACADOS_KINEMATIC_MPCC_SOLVER_INCLUDE_ACADOS_KINEMATIC_MPCC_SOLVER_ACADOS_KINEMATIC_MPCC_SOLVER \
        */
