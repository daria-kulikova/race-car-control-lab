                                             ...
                                             const reference_input& ref_input, const reference_on_track& safe_set)
{
  ...
  mpc_params[parameters::Cd0] = model_dynamics.Cd0;
  mpc_params[parameters::Cd1] = model_dynamics.Cd1;
  mpc_params[parameters::Cd2] = model_dynamics.Cd2;
  mpc_params[parameters::gamma] = model_dynamics.gamma;
  mpc_params[parameters::eps] = model_dynamics.eps;

  // TODO: Hardcoded!!!!!!
  mpc_params[parameters::car_width] = model_dynamics.car_width;
