...
#include "custom_sensor_model_template/vicon_sensor_model.h"
...
// TODO (1)
ViconSensorModel::ViconSensorModel(const Eigen::Matrix<double, crs_models::custom_model::custom_state::NX,
                                                       crs_models::custom_model::custom_state::NX>& R)
  : SensorModel(3, ViconSensorModel::SENSOR_KEY)
{
  // TODO (2)
