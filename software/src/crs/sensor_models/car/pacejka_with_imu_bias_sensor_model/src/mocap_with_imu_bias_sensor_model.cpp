...
MocapWithImuBiasSensorModel::MocapWithImuBiasSensorModel(const Eigen::Matrix3d& R)
  : SensorModel(3, MocapWithImuBiasSensorModel::SENSOR_KEY)  // Measurement dimension is three
{
...
const std::string MocapWithImuBiasSensorModel::SENSOR_KEY = "mocap";
