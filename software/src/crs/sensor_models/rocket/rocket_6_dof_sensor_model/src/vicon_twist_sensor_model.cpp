...
ViconTwistSensorModel::ViconTwistSensorModel(const Eigen::Matrix<double, 6, 6>& R)
  : SensorModel(6, ViconTwistSensorModel::SENSOR_KEY)  // Measurement dimension is 6
{
...
const std::string ViconTwistSensorModel::SENSOR_KEY = "vicon_twist";
