...
ViconPoseSensorModel::ViconPoseSensorModel(const Eigen::Matrix<double, 7, 7>& R)
  : SensorModel(7, ViconPoseSensorModel::SENSOR_KEY)  // Measurement dimension is three
{
...
const std::string ViconPoseSensorModel::SENSOR_KEY = "vicon_pose";
