...
// Estimator
typedef crs_estimators::kalman::DiscreteEKF<kinematic_car_state, kinematic_car_input> EkfType;
...
std::shared_ptr<EkfType> loadCRSEstimator<EkfType>(ros::NodeHandle& nh, ros::NodeHandle& nh_private)
{
  ...
  {
    ROS_WARN_STREAM("[Kinematic EKF Component Registry] No initial P set. Using identity.");
